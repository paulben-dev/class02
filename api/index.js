...
// All requires must be static (not dynamic paths) so Vercel's bundler can analyze them
// All route files are required statically so their transitive deps are bundled
...
// Static requires so Vercel bundler traces all dependencies
